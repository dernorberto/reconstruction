...
def createCV_canny():
	...
	obj=FreeCAD.ActiveDocument.addObject('App::DocumentObjectGroupPython','closing')
	...
	obj.addProperty('App::PropertyInteger','xsize',"closing").xsize=4
	obj.addProperty('App::PropertyInteger','ysize',"closing").ysize=4
	obj.addProperty('App::PropertyInteger','iterations',"closing").iterations=2
