...
#		setFixedWidth: 700
		...
		QtGui.QLabel:
		QtGui.QLabel:
			setText:"***    opening (delete snowfall)  ***"
		QtGui.QLabel:
...
'''
	...
	def change(self):
		self.obj.xsize=self.root.ids['xsize'].value()
		self.obj.ysize=self.root.ids['ysize'].value()
		self.obj.Proxy.execute(self.obj)
...
def createCV_canny():
	...
	obj=FreeCAD.ActiveDocument.addObject('App::DocumentObjectGroupPython','Opening')
	...
	obj.addProperty('App::PropertyInteger','xsize',"opening").xsize=4
	obj.addProperty('App::PropertyInteger','ysize',"opening").ysize=4
	obj.addProperty('App::PropertyInteger','iterations',"opening").iterations=2
